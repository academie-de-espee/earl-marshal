...
## Materials
* Abrasion-resistant material: material that withstands normal combat stresses (such as being snagged by an unbroken blade) without tearing.
...
* Puncture-resistant material: any fabric or combination of fabrics that will predictably withstand puncture.
    * MUST be tested every two years and must be tested the first time new gear is used or if no marshal on the field knows a given piece of gear to have been tested. They may also be tested at the marshal's discretion.
        * Fabric testing for protective gear should be done as described in the Society Fencing Marshal's Handbook in Appendix 1.
...
## How to Inspect
* Inspections are pass/fail first. Ensure that the fighter knows that they have passed or failed, and provide the reason for any failure.  A fighter should be given the opportunity to remedy the failure and return to the marshal who failed the item for re-inspection.
...
## Head
* Check masks and helms for fit, wear, and padding. Mask and helms should be inspected both on **AND** off the combatant. "It is the mask I always wear" is **NOT** sufficient
* Must be secured as to not be dislodged or removed during combat
    ...
    * Check for elastic bands that are no longer elastic
* Place your hand flat on the faceplate and ask the fighter to lean forward into your hand.  The mask/helm should not shift or contact their face
* Helmet faceplates must not have holes larger than 1/8" in diameter, with a minimum offset of 3/16"
* Check mask mesh for significant dents, especially if they flex.  If there is concern about the face mesh of a modern fencing mask, it should be tested using a standard commercial 12kg mask punch.  Marshals doing the testing shall be trained in the use of the punch.
* For CUT & THRUST – verify the back of the head is covered by rigid material lined by at least 1/4" (6mm) of closed cell foam or an equivalent padding.

## Neck
* For everything but light rapier, verify the fighter is wearing a rigid gorget covering the entire throat, backed by either puncture resistant material or the equivalent of 1/4" (6 mm) of open cell foam.
* Ensure the cervical vertebrae are protected by some combination of gorget, helm, and/or hood insert.
...
* Verify torso coverage won't shift significantly to provide a gap in armor

## Legs & Arms
* All other areas not discussed previously must be covered in abrasion-resistant material.  No bare skin
...
* All burrs on a blade must be removed prior to use
* Verify tips:
...
## Criteria for passing for light rapier and rapier
   * Comprehension and application of the SCA Rules of the List, SCA Fencing Marshal's Handbook, and the "General Policies" and "Rapier Combat" sections of the "Policies of the Kingdom Earl Marshal" in the Atlantian Book of Policy.
